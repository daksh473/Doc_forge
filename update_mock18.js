...
const digitalAssetsManager = require('./server/services/digitalAssetsManager');
...
async function updateMockData() {
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    p.digitalAssets = await digitalAssetsManager.processDigitalAssets(cleanProduct);
  }
...
`;
  ...
  console.log('mockProducts.js updated with Digital Assets data!');
}
